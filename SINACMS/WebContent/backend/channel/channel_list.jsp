        ...
        <td height="24" bgcolor="#353c44"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td><div align="right"><span class="STYLE1">
             ...
             &nbsp; <img src="images/del.gif" width="10" height="10" /> <a href="javascript:deleteChannels()">删除</a>    &nbsp;&nbsp;   &nbsp;
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      ...
      <tr>
        <td height="20" bgcolor="#FFFFFF"><div align="center">
          <input type="checkbox" name="checkbox2" value="${c.cid }"/>
        </div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><a href="#" title="点击查看和编辑频道">${c.title }</a></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${c.description }</div></td>
        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
        <a href="javascript:deleteChannel(${c.cid })" title="点击删除频道">删除</a> |
        <a href="channel/update_channel.jsp?cid=${c.cid}" title="点击编辑频道">编辑</a>
        </div></td>
      </tr>
      </c:forEach>
      </c:if>
