			...
			<td>
				<table width="100%" border="0" cellpadding="0" cellspacing="1"
					...
					<tr>
						...
						<td width="70" height="20" bgcolor="d3eaef" class="STYLE6"><div
								align="center">
						...
						<c:forEach items="${articles }" var="art">
							<tr>
								...
								<td height="20" bgcolor="#FFFFFF" class="STYLE19"><div
										align="center">
										<a href="#" title="点击查看和编辑文章">${art.title }</a>
									</div></td>
								<td height="20" bgcolor="#FFFFFF" class="STYLE19"><div
										align="center">
										<a href="${art.originUrl }" target="_blank">${art.originUrl }</a>
									</div></td>
								<td height="20" bgcolor="#FFFFFF" class="STYLE19"><div
										align="center">${art.clickNums }</div></td>
								<td height="20" bgcolor="#FFFFFF" class="STYLE19"><div
										align="center">${art.replyNums }</div></td>
								<td height="20" bgcolor="#FFFFFF" class="STYLE19"><div
										align="center">${art.createDateString }</div></td>
								<td height="20" bgcolor="#FFFFFF" class="STYLE19"><div
										align="center">${art.updateDateString }</div></td>
								<td height="20" bgcolor="#FFFFFF" class="STYLE19"><div
										align="center">${art.publishDateString }</div></td>
								<td height="20" bgcolor="#FFFFFF"><div align="center"
										class="STYLE21">
					...
					<c:if test="${empty articles }">
						<tr>
							<td colspan="9" height="20" bgcolor="#FFFFFF" class="STYLE19"><div
									align="center">没有文章可以显示</div></td>
						</tr>
					</c:if>
				</table>
			</td>
					...
					<tr>
						<td width="33%"><div align="left">
								<span class="STYLE22">&nbsp;&nbsp;&nbsp;&nbsp;共有<strong>
										<%=new ArticleDAO().queryCountArticle()%></strong> 条记录，当前第<strong>
										1</strong> 页，共 <strong>10</strong> 页
								</span>
							</div></td>
						<td width="67%" align=right vAlign="center" noWrap><a
							href="#">首页</a> <font color="red">1</font> <a href="#">2</a> <a
							href="#">3</a> <a href="#">下页</a> <a href="#">尾页</a> <select
